...
### Setting Up Your App Views

1. [Create an app](/instructions/get-api-key) if you haven't already.
2. [Create an app view](/instructions/create-app-views).
3. Set up your site to handle the path, and you're good to go!
