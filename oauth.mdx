...
3. Your application requests an **authorization token** from the Whop API by exchanging the code from the URL.
4. The Whop API returns an **authorization token**.
5. Your application uses the authorization token to request data about the authenticated user.
