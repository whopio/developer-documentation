...
1. Your user clicks on a link to your application from the **Whop Hub**.
2. Your user is redirected to your application with a code in the **URL**.
3. Your application requests an **authorization token** from the Whop API using that code.
4. The Whop API returns an **authorization token**.
5. Your application uses the authorization token to request data about the user
