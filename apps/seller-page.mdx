...
1. Create a page to match this URL `/seller/$companyId/$productId`. To do this, create this file: `/app/seller/[companyId]/[productId]/page.tsx`

```bash
mkdir app/seller && mkdir "app/seller/[companyId]" && mkdir "app/seller/[companyId]/[productId]" && touch "app/seller/[companyId]/[productId]/page.tsx"
```
...
These are all the options that you can use in the Seller Path, but for now, we will only use `companyId` and `productId`:
...
3. Update the Seller Path in your [app configuration](https://dash.whop.com/settings/developer) to be `/seller/$companyId/$productId`

   <Frame>
     <img src="https://imgur.com/I02L6Iv.png" />
   </Frame>

4. Navigate to your iFrame URL, you can do this easily by clicking on the banner at the top of the app settings page. This will redirect you to a demo product that has your app installed. From there, you can enable developer mode.
