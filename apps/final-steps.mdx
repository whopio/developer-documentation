...
We have created a simple API that allows you to fetch information about you may need for your app. We have wrapped this in a TypeScript SDK that handles authentication and other things for you. The SDK allows you to:
