...
<Frame>
  <img src="https://imgur.com/W5xwxU4.gif" />
</Frame>
...
Before we can start building, we need to create an app on Whop. If you haven't already, head to the [Developer Settings](https://dash.whop.com/settings/developer) page and create a new app.
