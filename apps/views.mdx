...
| ---------------- | ---------------------------------------------------------------- | --------------------------------------------------------------------- |
| `customer`       | Accessible by the user when they are viewing a whop              | Displaying sports picks to paying users                               |
| `seller_product` | Accessible by the seller when they are editing a product         | Uploading a file that the user can download for that specific app instance   |
...
The admin view is displayed on the **Edit Product Page**. This view is only accessible by the seller. It allows the app to have context about a specific product.
...
The analytics view is displayed on the "Analytics" tab. This view is only accessible by the seller. It allows the developer to offer a specific page for analytics about their app instance.
