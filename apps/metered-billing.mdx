...
Every Friday, Whop will aggregate all usage submitted the prior week and charge the seller for the amount used. This will be automatically to your balance for withdrawal.
