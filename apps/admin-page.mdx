...
The **admin page** is a specific page URL your app defines. Every time a company admin views your app from within the Whop Dashboard, they will view the admin page within the iFrame.
...
These are all the options that you can use in the Admin Path, but for now, we will only use `companyId` and `productId`:
