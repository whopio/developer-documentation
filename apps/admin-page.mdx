...
In order to know which company is viewing the page, Whop will pass the ID as a **path parameter**. These are defined in the URL on the app settings page, which we will do later.
