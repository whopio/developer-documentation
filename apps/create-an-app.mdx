...
Once you are signed in to our business dashboard with your company, you will need to enroll in our App Developer Alpha. If you are not currently enrolled, you can apply to join [**here**](https://whop.com/whop-apps-waitlist).

If you have been accepted, check out the Slack Channel for information on how to enable the beta on your company.
...
<Frame>
  <img src="https://imgur.com/LBTHQie.gif" />
</Frame>
...
2. Now you can open your app in its iFrame. On the app settings page, there will be a purple banner that will take you to a pre-created product with your app installed. Once you are on the page, you can click on the `Dev Mode` toggle in the bottom left.
