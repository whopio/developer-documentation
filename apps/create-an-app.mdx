...
Your first step is to create an app in Whop. Head to the [**Developer Settings**](https://dash.whop.com/settings/developer) and follow the guide below. This step is important to do before development as it gives you the credentials you will need to access the [**Whop SDK**](/apps/sdks).

![New App Guide](https://i.imgur.com/2LyCrYV.gif)

---

<Tip>
  Using Next.js? You can use our [**Next.js template**](/apps/next-template) to
  get started building instantly.
</Tip>
