...
Now that you have setup your project workspace, you will need to create your app in Whop to get the values required for the SDK to work. You can find the guide on how to do this [**here**](/apps/testing).
