...
There are 2 stages to creating an App on Whop, the first is setting it up on the dashboard, and the second is developing the App itself.
...
[INSERT VIDEO HERE BUT THERE WAS A CHECKOUT ERROR SO CANNOT DO]
