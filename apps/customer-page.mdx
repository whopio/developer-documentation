...
1. Create a page to match this URL `/customer/$experienceId`. To do this, create this file: `/app/customer/[experienceId]/page.tsx`

```bash
mkdir app/customer && mkdir "app/customer/[experienceId]" && touch "app/customer/[experienceId]/page.tsx"
```
...
3. Update the Customer Path in your [app configuration](https://whop.com/apps) to be `/customer/$experienceId`
