...
To make sure that we can retrieve the data we want from the API, we first need to check if the request was successful. If it wasn't, we will throw an error.
