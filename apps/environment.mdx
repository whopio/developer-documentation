...
We have created a SDK to make it easier to build apps on Whop. This SDK handles all the authentication, and API requests. To install it, run the following command:
...
As the app is ran in an iFrame and proxied through Whop, localhost development will not work. To get around this, we have created **developer mode**. This allows you to run your app locally, displaying real-time updates in the browser as you make changes.
