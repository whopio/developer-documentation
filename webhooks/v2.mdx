...
- [membership.went_valid](/webhooks/v2#membership-went-valid)
- [membership.went_invalid](/webhooks/v2#membership-went-invalid)
- [membership.metadata_updated](/webhooks/v2#membership-metadata-updated)
- [payment.succeeded](/webhooks/v2#payment-succeeded)
- [payment.failed](/webhooks/v2#payment-failed)
- [payment.affiliate_reward_created](/webhooks/v2#payment-affiliate-reward-created)
