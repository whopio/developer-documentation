---
title: V2
description: V2 Webhook Events
---

---

This page covers the events that the V2 webhooks will send. These will be sent to all companies. If you are an app, head to the [**V5 events**](/webhooks/v5).

- [membership.went_valid](/webhooks/examples#membership-went-valid)
- [membership.went_invalid](/webhooks/examples#membership-went-invalid)
- [membership.metadata_updated](/webhooks/examples#membership-metadata-updated)
- [payment.succeeded](/webhooks/examples#payment-succeeded)
- [payment.failed](/webhooks/examples#payment-failed)
- [payment.affiliate_reward_created](/webhooks/examples#payment-affiliate-reward-created)
