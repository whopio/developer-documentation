...
App Developers Office Hours is a monthly event organized by Whop, in which app developers building on Whop can get together and discuss the apps they are building. It is an open
place for asking questions, raising issues you are facing, and showcasing the apps you are working on.
...
Additionally, we will promote the 1st and 2nd place apps via Twitter and personally show them to a selection of our top sellers.
...
- Before starting, tweet out a description of your idea, and tag [@WhopIO](https://twitter.com/WhopIO).
  - Example: "I'm building a @WhopIO app that allows sellers to collect and rank suggestions from their members"
...
Here are examples of some of the most commonly requested apps from our sellers:

### "Sell access to X" apps

These are apps which sellers can purchase which enable them to sell access to different digital products on Whop, like:

- Sell access to a Slack workspace
- Sell acess to Notion templates
